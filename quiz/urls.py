...
from .views import QuizListView, CategoriesListView,\
    ...
    QuizMarkingDetail, QuizDetailView, QuizTake, index, login_user, logout_user, logcheck
from django.urls import path
from django.contrib import admin


urlpatterns = [         url(regex=r'^index/$', view=index, name='index'),
                        url(regex=r'^$', view=logcheck, name='logcheck'),
...
admin.site.index_title = "Welcome to Examination Portal!"